      ...
      <div className="row">
        ...
        <div className="main__content rounded-r-2xl">
          ...
          <article>
            ...
            <ul>
              <li>
                <Link href="pracownie/gospodarstwa" className="underline">
                  pracownia gospodarstwa domowego
                </Link>
              </li>
              <li>
                <Link href="/pracownie/rzemiosl" className="underline">
                  rzemiosł różnych
                </Link>
              </li>
              <li>
                <Link href="/pracownie/krawiecka" className="underline">
                  krawiecka
                </Link>
              </li>
              <li>
                <Link href="/pracownie/plastyczna" className="underline">
                  plastyczna
                </Link>
              </li>
              <li>
                <Link href="/pracownie/komputerowa" className="underline">
