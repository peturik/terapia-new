    ...
    <main className="main container site-about">
      <div className="main__content">
        ...
        <article>
          ...
          <ul>
            <li>
              Do WTZ przy ul. Truskawkowa 4, można dojechać komunikacją miejską
              (liniami tramwajowymi 10 lub 21 przystanek: Pleszów + autobusem
              131 przystanek: Kąkolowa 2)
            </li>
            <li>
          ...
          <p>
            W WTZ przy ul. Truskawkowej 4, odbywają się zajęcia w 5 pracowniach
            terapeutycznych, które prowadzą instruktorzy terapii zajęciowej. W
            placówce pracują psycholog i specjalista ds. rewalidacji.
          </p>
        </article>
        <article>
          ...
          <p>
            Rada Programowa to pracownicy warsztatu, którzy prowadzą zajęcia. W
            tym dokumencie zapisane są cele, nad którymi będziesz pracować w
            ciągu całego roku.
            <br />
